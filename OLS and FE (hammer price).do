...
capture mkdir "./Stata"
log using "./Stata/OLS_and_FE_hammer.log", replace
...
*** Summary statistics ***
	* Continuous + binary controls (means, SDs, N)
	local contbin_vars hammer_price artwork_measurements_width ///
	...
	esttab panelA using "./Stata/Summary Statistics/continous_variables.tex", replace ///
...
*** OLS ***
	...
	* OLS  
	eststo ols: reg hammer_price ib35.ah ib35.location ///
	...
	* Location FE
	eststo location_fe: reghdfe hammer_price ib35.ah c.lot_num i.cur ///
	...
	* Location and auction house FE
	eststo location_house_fe: reghdfe hammer_price c.lot_num i.cur ///
	c.artwork_measurements_width c.artwork_measurements_height ib4.med ///
	ib31.art ib1.nat c.auction_year i.signed i.has_provenance ///
	...
	* Location, auction house, and year FE
	eststo location_house_year_fe: reghdfe hammer_price c.lot_num i.cur ///
	c.artwork_measurements_width c.artwork_measurements_height ib4.med ///
	...
	* Make table without saving and display in results window
	esttab ols location_fe location_house_fe location_house_year_fe, ///
		...
		title("Determinants of Hammer Price")

	* Make table and save it
	esttab ols location_fe location_house_fe location_house_year_fe ///
		using "./Stata/Regressions/reg_hammer.tex", replace ///
